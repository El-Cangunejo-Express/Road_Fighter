...
public class GameObjectBuilder {
	...
	private List<ObjetoDelMapa> allGameObjects = new ArrayList<ObjetoDelMapa>();
	...
	public void removeAll() {
		ObjetoDelMapa[] arrayGameObjects = allGameObjects.toArray(new ObjetoDelMapa[allGameObjects.size()]);
